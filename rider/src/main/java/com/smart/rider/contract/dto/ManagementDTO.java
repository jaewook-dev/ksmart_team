...
public class ManagementDTO {
	...
	public String toString() {
		return "ManagementDTO [memberId=" + memberId + ", contractMethod=" + contractMethod + ", contractPay="
				+ contractPay + ", contractManagementCode=" + contractManagementCode + ", contractCode=" + contractCode
