...
public class UtilityController {
	...
	public String spendUtilityDelete(@RequestParam(value = "spendUtilityCode") String spendUtilityCode
		...
		//System.out.println(selectShopCode + " <-- selectShopCode spendUtilityDelete() UtilityController.java");
	...
	public String spendUtilityDetails(@RequestParam(value = "selectShopCode", required = false, defaultValue = "SR0000") String selectShopCode
									, String spendUtilityCode
									, Model model) {
		//System.out.println(spendUtilityCode + " <-- spendUtilityCode spendUtilityDetails UtilityController.java");
		//System.out.println(selectShopCode + " <-- selectShopCode spendUtilityDetails() UtilityController.java");
	...
	public String spendUtilityList(@RequestParam(value = "utilityKey") String utilityKey
		...
		//System.out.println(utilityKey + " < -- utilityKey spendUtilityList() UtilityController.java");
		//System.out.println(utilityValue + " < -- utilityValue spendUtilityList() UtilityController.java");
		//System.out.println(beginDate + " < -- beginDate spendUtilityList() UtilityController.java");
		//System.out.println(endDate + " < -- endDate spendUtilityList() UtilityController.java");
		//System.out.println(selectShopCode + " <-- selectShopCode  spendUtilityList() UtilityController.java");
	...
	public String spendUtility(Model model, HttpSession session 
		...
		this.spendUtilityList(utilityKey, utilityValue, beginDate, endDate, utilityYear, currentPage, selectShopCode, session, model);
